...
Pretend that I asked you to visualize a sound wave. You might, in your mind’s eye, see a smooth, geometric waveform oscillating in a regular up-and-down pattern into infinity. That, my friend, is a sine wave.

There are many, horribly complex ways to describe sine waves, which I fully intend to avoid in this piece (because I do not understand them). Instead, I want to talk about why I, as a visual designer and engineer, love them: they unlock the possibility to convert time into fluid, repeating motion.

- periodic (loops)
- regular (fluid motion)
