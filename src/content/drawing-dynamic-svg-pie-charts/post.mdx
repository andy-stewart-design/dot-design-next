...
However, it’s worth noting that the viewBox is entirely independent of the SVG’s rendered size. No matter how large or small the SVG is displayed on screen, the viewBox—and coordinates of the grid that it defines—never changes.
