...
2. The third number describes the rotation of the underlying ellipse. This only has an effect if your x- and y-radii are different, so we can safely set this to 0 and move on. (And honestly, I would most likely reach for the [bezier line command](https://developer.mozilla.org/en-US/docs/Web/SVG/Tutorial/Paths#b%C3%A9zier_curves) before I bothered trying to work with this.)
