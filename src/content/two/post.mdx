...
A little Figma plugin I released last year recently passed 4K users. Not bad for a project that I published and then promptly never mentioned publicly.
...
![AllStock promo image](/blog/allstock-announcement/AllStock-Cover-5x3.jpg)
...
![The Figma quick actions menu being used to search a plugin called AllStock for images of rainbows](/blog/allstock-announcement/allstock-quickactions.jpg)
...
![A visualization showing data being sent from an image service through Vercel to Figma in order to protect the API keys needed to access the data](/blog/allstock-announcement/allstock-performance.jpg)
...
![Detail view of the AllStock filter menu showing the export image quality and size inputs](/blog/allstock-announcement/allstock-imagequality.jpg)
...
![Detail view of the AllStock search bar. The value of search input is "portrait," and the the user is hovering over a button with the Unsplash logo](/blog/allstock-announcement/allstock-interface.jpg)
